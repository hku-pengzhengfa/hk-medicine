...
public class MusicInfoController {
    ...
    public Result<IPage<MusicInfo>> selectSingerMusicPage(@Valid @RequestBody MusicDto musicDto) {
    ...
    @ApiOperation("查询我历史播放列表")
    @RequestMapping(value = "/selectMusicHistoryPage", method = RequestMethod.POST)
    public Result<IPage<MusicInfo>> selectMusicHistoryPage(@Valid @RequestBody MusicDto musicDto) {
        return Result.success(musicInfoService.selectMusicHistoryPage(musicDto), "Request succeeded");
    }
}
